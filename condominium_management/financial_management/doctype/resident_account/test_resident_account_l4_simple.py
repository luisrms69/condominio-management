#!/usr/bin/env python3
"""
REGLA #49 - Resident Account Layer 4 Simple Test
...
class TestResidentAccountL4Simple(FrappeTestCase):
	...
	def test_json_configuration_validation(self):
		...
		# Check critical fields for Resident Account
		field_names = [f.get("fieldname") for f in fields]
		critical_fields = ["resident_name", "account_status", "current_balance"]
